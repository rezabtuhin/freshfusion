    ...
    <aside id="logo-sidebar"
        ...
        <div class="bg-gray-200 h-full px-3 pb-4 overflow-y-auto dark:bg-gray-800">
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="/donation"
                       class="{{ $path == 'donation' ? 'bg-gray-50' : ''}} flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Donate Now</span>
                    </a>
                </li>
                <li>
