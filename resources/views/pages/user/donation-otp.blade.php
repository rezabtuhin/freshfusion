<x-user-layout title="Donation | Pin" orders="{{ $count }}">
    <form class="max-w-md mx-auto h-96 flex items-center justify-center bg-pink-700 p-4" action="/pin/donation" method="POST">
        @csrf
        <div>
